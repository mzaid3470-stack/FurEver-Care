document.addEventListener('DOMContentLoaded', async () => {
  ...
  const routeIds = {
    'sarah-mitchell.html': 'vet-01',
    'ryan-carter.html': 'vet-02',
    'maya-patel.html': 'vet-03',
    'daniel-brooks.html': 'vet-04'
  };
  const vetId = document.body.dataset.vetId || routeIds[pageName];
  ...
  const fallbackData = {
    ...
    "vet-03": { image: "https://images.unsplash.com/photo-1594824476967-48c8b964273f?auto=format&fit=crop&w=900&h=1100&q=85&crop=faces" },
