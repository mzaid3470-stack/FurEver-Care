    ...
    return `
      <article class="card-editorial reveal-on-scroll is-visible">
        ...
        <div class="card-media" style="height: 280px;">
          <img src="${vet.image}" alt="${vet.name}" style="height: 100%; width: 100%; object-fit: cover; object-position: center 28%;" loading="lazy" referrerpolicy="no-referrer" onerror="this.onerror=null; const fallbacks={'vet-01':'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=900&h=1100&q=85&crop=faces','vet-02':'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=900&h=1100&q=85&crop=faces','vet-03':'https://images.unsplash.com/photo-1550831107-1553da8c8464?auto=format&fit=crop&w=900&h=1100&q=85&crop=faces','vet-04':'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&w=900&h=1100&q=85&crop=faces'}; this.src=fallbacks[vet.id] || fallbacks['vet-01'];">
        </div>
